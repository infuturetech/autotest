...
@pytest.mark.p2
def test_search_algo_results_set_invalid_stream_id(host):
    """
    指定错误的stream_id查询算法推理结果
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 指定错误的stream_id查询算法推理结果")
    ...
    results = OpenApi.search_algo_task_result_time_range(host, stream_id + "11" , algo_id, start_time, end_time)
