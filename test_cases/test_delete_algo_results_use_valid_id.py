...
@pytest.mark.p0
def test_delete_algo_results_use_valid_id(host):
    """
    删除一条存在的算法推理结果
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 删除一条存在的算法推理结果")
    ...
    algo_result_id = results["data"][1]["algo_result_id"]

    rt = OpenApi.delte_algo_task_result_by_id(host, algo_result_id)
