...
@pytest.mark.p2
def test_delete_algo_results_time_range_not_set(host):
    """
    未指定时间范围删除指定算法推理结果
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 未指定时间范围删除指定算法推理结果")
    ...
    rr = OpenApi.delete_algo_task_result_time_range(host, algo_id, None, None, stream_id)
