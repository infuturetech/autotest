...
@pytest.mark.p2
def test_search_algo_results_set_invalid_algo_id(host):
    """
    指定错误的算法id查询算法推理结果
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 指定错误的算法id查询算法推理结果")
    ...
    results = OpenApi.search_algo_task_result_time_range(host, stream_id, algo_id + "11" , start_time, end_time)
