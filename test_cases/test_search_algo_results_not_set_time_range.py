...
@pytest.mark.p0
def test_search_algo_results_not_set_time_range(host):
    """
    未指定时间范围查询算法任务结果
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 未指定时间范围查询算法任务结果")
    ...
    results = OpenApi.search_algo_task_result_time_range(host, stream_id, algo_id, start_time=None, end_time=None)
