...
@pytest.mark.p1
def test_add_camera_use_2k_video(host):
    """
    添加分辨率为2k的相机点位
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 添加分辨率为2k的相机点位")
    camera_data = OpenApi.add_camera_data(host, camera_name="test_2k", region_id=region_id(), address=rtsp_2k, factory="mock", protocol="rtsp")
