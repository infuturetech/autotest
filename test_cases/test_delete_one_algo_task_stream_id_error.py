...
@pytest.mark.p2
def test_delete_one_algo_task_stream_id_error(host):
    """
    使用错误的streamid删除推理任务
    Args:
        host (_type_): _description_
    """
    log.info("测试点: 使用错误的streamid删除推理任务")
    ...
    rrr = OpenApi.delete_algo_task(host, algo_id, "stream_id")
